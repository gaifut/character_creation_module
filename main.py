...
def attack(char_name, char_class):
    """Calculate attack value based on class."""
...
def defence(char_name, char_class):
    """Calculate defense value based on class."""
    if char_class == 'warrior':
...
def special(char_name, char_class):
    """Calculate special power value based on class."""
    if char_class == 'warrior':
...
def choice_char_class():
    """Choose class by typing in string value."""
    approve_choice = None
    char_class = None
